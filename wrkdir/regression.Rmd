...
credit_norm$checking_balance = credit[1]
credit_norm$credit_history = credit[3]
credit_norm$purpose = credit[4]
credit_norm$savings_balance = credit[6]
credit_norm$employment_duration = credit[7]
credit_norm$other_credit = credit[11]
credit_norm$housing = credit[12]
credit_norm$job = credit[14]
credit_norm$phone = credit[16]
```
```{r}
set.seed(123)
